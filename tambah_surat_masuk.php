                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                                ...
                                                if($result > 0){
                                                   ...
                                                   // $ekstensi = array('jpg','png','jpeg','doc','docx','pdf');
                                                    $ekstensi = array('jpg','png','jpeg','gif','bmp','doc','docx','pdf','xls','xlsx','ppt','pptx','rar','zip','txt','ai','word');
...
<select id="kode" name="kode"  class="validate" required>
   <option disabled selected> </option>
    ...
    ?>
                           ...
                           <!-- <input id="kode" type="text" class="validate" name="kode" required>--->
                                ...
                                ?>
                            <label for="kode">Pilih Jenis Surat</label>
                        </div>
                        <div class="input-field col s6">
                            ...
                            <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                   ...
                                   <!-- <small class="red-text">*Format file yang diperbolehkan *.JPG, *.PNG, *.DOC, *.DOCX, *.PDF dan ukuran maksimal file 2 MB!</small>--->
                                      <small class="red-text">*Format file yang diperbolehkan *.JPG, *.PNG, *.GIF,  *.BMP,*.DOC, *.DOCX, *.PDF, *.XLS, *.XLSX, *.PPT, *.PPTX, *.RAR, *.ZIP, *.TXT, *.AI, *.WORD,   dan ukuran maksimal file 2 MB!</small>
                                    <small class="red-text">Nomor Agenda harus diisi angka!</small>
                                   <small class="red-text">No Surat hanya boleh mengandung karakter huruf, angka, spasi, titik(.), minus(-) dan garis miring(/)</small>
                                   <small class="red-text">Form Asal Surat hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-),kurung() dan garis miring(/)</small>
                                   <small class="red-text">Isi Ringkas hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), kurung(), underscore(_), dan(&) persen(%) dan at(@)</small>
                                   <small class="red-text">Indeks hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan koma(,) dan minus (-)</small>
                                   <small class="red-text">Tanggal Surat hanya boleh mengandung angka dan minus(-)</small>
                                   <small class="red-text">Keterangan hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()</small>
                                </div>
                            </div>
                        </div>
                    </div>
