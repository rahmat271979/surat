...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">Aplikasi</i> RY</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Rumah Yatim</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jalan Buah Batu No. 296</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li><a href="?page=ref"><i class="material-icons middle">class</i> Jenis Surat</a></li>
            <li class="no-padding">
            <?php
                if($_SESSION['admin'] == 1){ ?>
                <ul class="collapsible collapsible-accordion">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">local_post_office </i> RY</a></li>
            <li><div class="grs"></></li>
            ...
            <li><a href="?page=ref">Jenis Surat</a></li>
            <?php
                if($_SESSION['admin'] == 1){ ?>
