...
<div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5>Aplikasi Sederhana Manajemen Surat (AMS) memiliki beberapa fitur yaitu :</h5>
<p class="description">1. Cetak disposisi surat masuk</p>
<p class="description">2. Cetak agenda surat masuk dan keluar berdasarkan tanggal tertentu</p>
<p class="description">3. Upload lampiran file surat, baik file scan/gambar(.JPG, .PNG) serta file dokumen (.DOC, .DOCX dan .PDF)</p>
<p class="description">4. Fitur galeri file lampiran yang diupload</p>
<p class="description">5. Upload kode klasifikasi surat format *.CSV (file excel)</p>
<p class="description">6. Multilevel user</p>
<p class="description">7. Fitur backup dan restore database</p>
